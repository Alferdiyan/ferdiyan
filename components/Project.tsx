...
export default function Project() {
  const projects = [
    { gambar: project1, projectTitle: 'Noteworthy technology', deskripsi: 'Product design' },
    { gambar: project2, projectTitle: 'Clonning Heylink me', deskripsi: 'Fornt End developer' },
    { gambar: project3, projectTitle: 'Alpo Picture', deskripsi: 'Web Developer' },
  ];
      ...
      <div className="flex justify-center ">
        <div className="flex flex-wrap gap-3 items-center justify-center">
          {projects.map((project, index) => (
            <ProjectCard key={index} gambar={project.gambar} projectTitle={project.projectTitle} deskripsi={project.deskripsi} />
          ))}
        </div>
      </div>
    </div>
